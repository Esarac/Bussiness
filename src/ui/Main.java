...
public class Main{
	...
	*/
	...
	//Initializer
	/**
	*<b>Description:</b> This method initialize the scanner, the holding and some extra elements inside the holding.<br>
	*<b>Post:</b> All the attributes and extra elements of the class are initialize.<br>
	*/
	public void init(){
		...
		holding.addEmployee("Isabella Villamil", "Asistente", "isabellavillamilcardenas@gmail.com", "1007678665");
	...
	//Menu
	/**
	*<b>Description:</b> This method show the user interface menu.<br>
	*<b>Pre:</b> The holding or scanner can not be null.<br>
	*@throws NullPointerException If the holding or scanner are null.
	*/
	public void menu(){
	...
	//Askers
	/**
	*<b>Description:</b> Ask some of the constants to the user and return the answer.<br>
	*@param constantClass The class from it comes from the constant.
	*@return A String that is the constant(The answer).
	*/
	...
	/**
	*<b>Description:</b> Ask an integer to the user and return the answer. It haves a minimum and a maximum.<br>
	*@param start The minimum integer that the user can choose.
	*@param end The maximum integer that the user can choose.
	*@return A int that is the answer.
	*/
	...
	/**
	*<b>Description:</b> Ask an integer to the user and return the answer. It only haves a minimum.<br>
	*@param start The minimum integer that the user can choose.
	*@return A int that is the answer.
	*/
	...
	/**
	*<b>Description:</b> Ask a double to the user and return the answer. The minimum possible answer is <code>0</code>.<br>
	*@return A double that is the answer.
	*/
	...
	/**
	*<b>Description:</b> Ask a boolean to the user and return the answer. The answers could be 1 if it is <code>true</code> or 2 if it is <code>false</code>.<br>
	*@return A boolean that is the answer.
	*/
